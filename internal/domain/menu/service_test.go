...
func (f *fakeProductRepository) SaveProduct(ctx context.Context, request *menu.SaveProductRequest) (*menu.Product, error) {
	if f.onSaveProduct == nil {
		panic("onSaveProduct function is not implemented")
	}
	return f.onSaveProduct(ctx, request)
}
